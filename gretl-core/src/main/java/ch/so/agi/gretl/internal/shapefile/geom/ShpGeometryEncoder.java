package ch.so.agi.gretl.internal.shapefile.geom;

import ch.so.agi.gretl.internal.shapefile.ShapefileMappingException;
import ch.so.agi.gretl.internal.shapefile.core.Bounds;
import ch.so.agi.gretl.internal.shapefile.core.EncodedShape;
import ch.so.agi.gretl.internal.shapefile.core.EndianByteBuffer;
